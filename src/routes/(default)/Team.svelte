...
<section class="py-32 relative">
	<div class="absolute left-0 bottom-0 w-full h-[50%] -z-10 bg-surface-100-800-token"></div>
	<Container addClass="flex flex-col gap-10">
		<div class="flex flex-col md:flex-row">
			...
			>
				Team <span class="text-primary-600">.</span>
			</h2>
		...
		<div class="flex flex-wrap mt-20">
			...
			>
				<img
					...
					alt="team"
					class="w-full max-w-[170px] sm:max-w-[265px] md:max-w-[70%] mx-auto aspect-[1/1.2] object-cover"
				/>
